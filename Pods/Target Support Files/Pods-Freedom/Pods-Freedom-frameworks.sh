...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ACAlertController/ACAlertController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ElasticTransitionObjC/ElasticTransitionObjC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FLAnimatedImage/FLAnimatedImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FMDB/FMDB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HYBUnicodeReadable/HYBUnicodeReadable.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PPRevealSideViewController/PPRevealSideViewController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ScottAlertController/ScottAlertController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SmartJSWebView/SmartJSWebView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SnapKit/SnapKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftWebViewBridge/SwiftWebViewBridge.framework"
