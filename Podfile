...
target 'Freedom' do
    ...
    #pod 'ElasticTransition','~>3.0.0' #Swift版本 /lkzhao/ElasticTransition
    ...
    #第二版
    pod 'BaseScrollView', '~> 0.1.8'
    pod 'BaseStaticTableView', '~> 0.1.8'
    pod 'BaseFillTableViewController', '~> 0.1.6'
    pod 'BaseCollectionView', '~> 0.1.6'
    pod 'BaseTableView', '~> 0.1.7'
#    pod 'BaseFile'
#    pod 'XExtension'
    pod 'XCategory', '~> 0.2.3'
    pod 'XCarryOn', '~> 0.1.6'
