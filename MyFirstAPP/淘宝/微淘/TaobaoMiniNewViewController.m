...
@end
@implementation TaobaoMiniNewViewCell
-(void)initUI{
    [super initUI];
...
@end
@implementation TaobaoMiniNewViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    [self fillTheTableDataWithHeadV:nil footV:nil canMove:NO canEdit:NO headH:0 footH:0 rowH:280 sectionN:1 rowN:11 cellName:@"TaobaoMiniNewViewCell"];
