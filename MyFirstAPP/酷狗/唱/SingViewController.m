...
-(void)initUI{
    ...
    UIButton *fujin = [[UIButton alloc]initWithFrame:CGRectMake(0, banner.y+banner.height+ 20, APPW/2, 80)];
    ...
    UIButton *paihang = [[UIButton alloc]initWithFrame:CGRectMake(fujin.width, fujin.y, fujin.width, fujin.height)];
    ...
    UIButton *guanzhu = [[UIButton alloc]initWithFrame:CGRectMake(fujin.x, fujin.y+fujin.height, fujin.width, fujin.height)];
    ...
    UIButton *wode = [[UIButton alloc]initWithFrame:CGRectMake(guanzhu.width, guanzhu.y, fujin.width, fujin.height)];
    ...
    UIButton *woyaochang = [[UIButton alloc]initWithFrame:CGRectMake((APPW-100)/2,guanzhu.y-50, 100, 100)];
    ...
    UIView *cell = [[UIView alloc]initWithFrame:CGRectMake(0, guanzhu.y+guanzhu.height, APPW, 60)];
    UIImageView *icon = [[UIImageView alloc]initWithFrame:CGRectMake(20, 10, 40, 40)];
    icon.image = [UIImage imageNamed:@""];
    UILabel *textLabel = [[UILabel alloc]initWithFrame:CGRectMake(icon.x+icon.width,icon.y, 100, 40)];
    textLabel.text = @"大赛";
    UILabel *accessoryText = [[UILabel alloc]initWithFrame:CGRectMake(APPW-200, icon.y, 200, 40)];
