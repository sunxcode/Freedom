...
@interface PersonalApplyViewCell:UITableViewCell
...
@end
@interface PersonalApplyViewController ()<UITableViewDelegate,UITableViewDataSource>{
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    PersonalApplyViewCell *cell = [tableView dequeueReusableCellWithIdentifier: @"cell"];
    if (cell == nil) {
        cell = [[PersonalApplyViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
