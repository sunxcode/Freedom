//
//  PersonalIndustryViewController.m
//  MyFirstAPP
//
...
#import "PersonalIndustryViewController.h"
#import "PersonalCompanyViewController.h"
@interface PersonalCompanyViewCell:UITableViewCell
-(void)setdatawithdict:(NSDictionary *)dict;
@end
@implementation PersonalCompanyViewCell{
    UILabel *titleLable;
...
@end
@interface PersonalIndustryViewController ()<UITableViewDelegate,UITableViewDataSource>{
    UITableView *refTableView;
    UILabel *label;
}
@end

@implementation PersonalIndustryViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self loadUI];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    PersonalCompanyViewCell *cell = [tableView dequeueReusableCellWithIdentifier: @"cell"];
    if (cell == nil) {
        cell = [[PersonalCompanyViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self pushController:[PersonalIndustryViewController class] withInfo:nil withTitle:[dict valueForJSONKey:@"name"] withOther:dict];
