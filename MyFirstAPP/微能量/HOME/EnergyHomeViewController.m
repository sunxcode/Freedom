...
#import "EnergyListViewController.h"
#import "EnergyDetailViewController.h"

@interface EnergyDetailViewCell : UICollectionViewCell{
    UIView *view;
...
@end
@implementation EnergyDetailViewCell
...
@end
@interface EnergyDetailLayout : UICollectionViewFlowLayout
@end
@implementation EnergyDetailLayout
- (instancetype)init{
    self = [super init];
    if (self) {
        // 设置item的大小
...
@end
@interface EnergyHomeViewController()<UICollectionViewDelegate,UICollectionViewDataSource>{
...
-(void)buildUI{
    ...
    juheAPICollectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, YH(banner), kScreenWidth,kScreenHeight-100) collectionViewLayout:[[EnergyDetailLayout alloc]init]];
    ...
    [juheAPICollectionView registerClass:[EnergyDetailViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    EnergyDetailViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    if(!cell){
        cell = [[EnergyDetailViewCell alloc]initWithFrame:CGRectMake(0, 0, 100, 120)];
    }
