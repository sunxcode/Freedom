...
@interface EnergyDetailViewCell1:UITableViewCell
-(void)setdatawithdict:(NSDictionary *)dict;
@end
@implementation EnergyDetailViewCell1{
    UILabel *titleLable;
...
@end
@interface EnergyListViewController ()<UITableViewDelegate,UITableViewDataSource>{
    UITableView *refTableView;
    UILabel *label;
}
@end

@implementation EnergyListViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    EnergyDetailViewCell1 *cell = [tableView dequeueReusableCellWithIdentifier: @"cell"];
    if (cell == nil) {
        cell = [[EnergyDetailViewCell1 alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self pushController:[EnergyDetailViewController class] withInfo:nil withTitle:[dict valueForJSONKey:@"name"] withOther:dict];
