...
@end
@interface SinaEmotionTabBarButton : UIButton
@end
@implementation SinaEmotionTabBarButton
...
@property (nonatomic, weak) SinaEmotionTabBarButton *selectedBtn;
@end
 ...
 *
 *  @param title 按钮文字*/
- (SinaEmotionTabBarButton *)setupBtn:(NSString *)title buttonType:(XFEmotionTabBarButtonType)buttonType {
    
    SinaEmotionTabBarButton *btn = [[SinaEmotionTabBarButton alloc]init];
...
-(void)setDelegate:(id<XFEmotionTabBarDelegate>)delegate {
    ...
    //选中默认按钮
    [self btnClick:(SinaEmotionTabBarButton *)[self viewWithTag:XFEmotionTabBarButtonTypeDefault]];
    
    
}
/*按钮点击*/
- (void)btnClick:(SinaEmotionTabBarButton *)btn {
...
- (void)layoutSubviews{
    ...
    for (int i = 0; i<btnCount; i++) {
        SinaEmotionTabBarButton *btn = self.subviews[i];
