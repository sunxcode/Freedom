...
class SinaComposeViewController: SinaBaseViewController,UITextViewDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if  let ac = acount {
            ...
            attStr.addAttribute(NSAttributedStringKey.font, value: UIFont.boldSystemFont(ofSize: 16), range: (str as NSString).range(of: prefix))
            attStr.addAttribute(NSAttributedStringKey.font, value: UIFont.systemFont(ofSize: 12), range: (str as NSString).range(of: ac.name))
    ...
    func keyboardWillChangeFrame(_ notification: Notification) {
        ...
        let keyboardF : CGRect = ((notification.userInfo![UIKeyboardFrameEndUserInfoKey] as AnyObject).cgRectValue)!
    ...
    func openImagePickerController(_ type: UIImagePickerControllerSourceType) {
