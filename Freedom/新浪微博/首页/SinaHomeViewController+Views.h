...
@interface SinaTitleButton : UIButton
@end
...
@end
@interface SinaLoadMoreFooter : UIView
@end
@class SinaDropdownView;
@protocol SinaDropdownViewDelegate <NSObject>
@optional
- (void)dropdownMenuDidDismiss:(SinaDropdownView *)menu;
- (void)dropdownMenuDidShow:(SinaDropdownView *)menu;
@end
@interface SinaDropdownView : UIView
+(instancetype)menu;
// 显示
...
@property (nonatomic,weak) id <SinaDropdownViewDelegate> delegate;
@end
@interface SinaStatusFrame : NSObject
...
@property (nonatomic,strong) SinaStatusFrame *statusFrame;
+(instancetype)cellWithTableView:(UITableView *)tableView;
@end
@interface SinaHomeViewController (Views)
@end
