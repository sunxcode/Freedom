...
@end
@interface SinaStatusPhotosView : UIView
...
@end
@interface SinaStatusPhotoView : UIImageView
@property (nonatomic, strong) SinaPhoto *photo;
@end
@interface SinaStatusPhotoView()
@property (nonatomic, weak) UIImageView *gifView;
@end
@implementation SinaStatusPhotoView
- (UIImageView *)gifView{
    if (!_gifView) {
...
@end
@implementation SinaStatusPhotosView
-(id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
    }
...
- (void)setPhotos:(NSArray *)photos{
    ...
    while (self.subviews.count < photosCount) {
        SinaStatusPhotoView *photoView = [[SinaStatusPhotoView alloc] init];
        [self addSubview:photoView];
    }
    // 遍历所有的图片控件，设置图片
    for (int i = 0; i<self.subviews.count; i++) {
        SinaStatusPhotoView *photoView = self.subviews[i];
        if (i < photosCount) { // 显示
...
@end
@implementation SinaStatusFrame
-(void)setStatus:(SinaStatus *)status {
    _status  = status;
    ...
    if (status.pic_urls.count) {
        ...
        CGSize photosSize = [SinaStatusPhotosView sizeWithCount:(int)status.pic_urls.count];
    ...
    if (status.retweeted_status) {
        SinaStatus *retweeted_status = status.retweeted_status;
        SinaUser *retweeted_status_user = retweeted_status.user;
        /** 被转发微博正文 */
        ...
        if (retweeted_status.pic_urls.count) { // 转发微博有配图
            CGSize retweetPhotosSize = [SinaStatusPhotosView sizeWithCount:(int)retweeted_status.pic_urls.count];
...
@end
@implementation SinaTitleButton
...
@end
@implementation SinaLoadMoreFooter
-(id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
...
@end
@interface SinaDropdownView()
//  将来用来显示具体内容的容器
@property (nonatomic, weak) UIImageView *containerView;
@end
@implementation SinaDropdownView
...
@end
@interface SinaStatusToolbar : UIView
@property(nonatomic,strong)SinaStatus *status;
+(instancetype)toolbar;
@end
@interface SinaStatusToolbar()
/** 里面存放所有的按钮 */
...
@end
@implementation SinaStatusToolbar
-(NSMutableArray *)btns {
    if (!_btns) {
...
@end
@interface SinaIconView : UIImageView
@property (nonatomic,strong) SinaUser *user;
@end
@interface SinaIconView ()
@property (nonatomic,weak)UIImageView *verifiedView;
@end
@implementation SinaIconView
-(id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
    }
...
@end
@interface SinaStatusViewCell ()
/* 原创微博 */
/** 原创微博整体 */
@property (nonatomic, weak) UIView *originalView;
/** 头像 */
@property (nonatomic, weak) SinaIconView *iconView;
/** 会员图标 */
@property (nonatomic, weak) UIImageView *vipView;
/** 配图 */
@property (nonatomic, weak) SinaStatusPhotosView *photosView;
/** 昵称 */
...
/** 转发配图 */
@property (nonatomic, weak) SinaStatusPhotosView *retweetPhotosView;
/** 工具条 */
@property (nonatomic, weak) SinaStatusToolbar *toolbar;
@end
...
-(void)setupToolbar{
    SinaStatusToolbar *toolbar = [[SinaStatusToolbar alloc]init];
...
- (void)setupRetweet {
    ...
    /** 转发微博配图 */
    SinaStatusPhotosView *retweetPhotosView = [[SinaStatusPhotosView alloc] init];
...
- (void)setupOriginal {
    ...
    /** 头像 */
    SinaIconView *iconView = [[SinaIconView alloc] init];
    ...
    /** 配图 */
    SinaStatusPhotosView *photosView = [[SinaStatusPhotosView alloc] init];
...
-(void)setStatusFrame:(SinaStatusFrame *)statusFrame {
    _statusFrame = statusFrame;
    SinaStatus *status = statusFrame.status;
    SinaUser *user = status.user;
...
@end
@implementation SinaHomeViewController (Views)
@end
