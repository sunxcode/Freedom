...
class DetailView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        topScrollView.contentInset = UIEdgeInsetsMake(0, 0, 44, 0)
        addSubview(topView)
    ...
    func reloadData() {
        ...
        print(sectionHeight)
        topScrollView.contentInset = UIEdgeInsetsMake(370 - 20, 0, 44, 0)
        topScrollView.addSubview(topScrollPageView)
        topScrollView.sendSubview(toBack: topScrollPageView)
