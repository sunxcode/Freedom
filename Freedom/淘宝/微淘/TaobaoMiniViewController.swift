...
class TaobaoMiniViewController: TaobaoBaseViewController {
    override func viewDidLoad() {
        ...
        let TaobaoMiniScrollV = BaseScrollView(contentIconView: CGRect(x: 0, y: 0, width: Int(APPW), height: Int(APPH - TabBarH) - 55), titles: titles, icons: icons, controllers: [], in: self)
