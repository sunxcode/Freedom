...
class FreedomViewController: FreedomBaseViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    override func viewDidLoad() {
        ...
        self.collectionView.register(FreedomViewCell.self, forCellWithReuseIdentifier: FreedomViewCell.getColloctionCellIdentifier())
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell:FreedomViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: FreedomViewCell.getColloctionCellIdentifier(), for: indexPath) as! FreedomViewCell
