...
class AlipayServiceTableViewController: AlipayBaseViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell: AlipayServiceTableViewCell? = tableView.dequeueReusableCell(withIdentifier: AlipayServiceTableViewCell.getTableCellIdentifier()) as? AlipayServiceTableViewCell
        if cell == nil {
