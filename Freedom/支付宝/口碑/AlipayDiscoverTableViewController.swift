...
class AlipayDiscoverTableViewController: AlipayBaseViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell: AlipayDiscoverTableViewControllerCell? = tableView.dequeueReusableCell(withIdentifier: AlipayDiscoverTableViewControllerCell.getTableCellIdentifier()) as? AlipayDiscoverTableViewControllerCell
        if cell == nil {
