...
class AlipayAssetsTableViewController: AlipayBaseViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell: AlipayAssetsTableViewControllerCell? = tableView.dequeueReusableCell(withIdentifier: AlipayAssetsTableViewControllerCell.getTableCellIdentifier()) as? AlipayAssetsTableViewControllerCell
        if cell == nil {
