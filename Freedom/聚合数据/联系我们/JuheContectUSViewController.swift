...
class JuheContectUSViewController: JuheBaseViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    self.collectionView.dataSource = self;
        self.collectionView.register(JuheContectUSViewCell.self, forCellWithReuseIdentifier: JuheContectUSViewCell.getColloctionCellIdentifier())
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: JuheContectUSViewCell.getColloctionCellIdentifier(), for: indexPath) as? JuheContectUSViewCell
