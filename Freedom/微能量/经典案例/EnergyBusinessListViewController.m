...
@interface EnergyBusinessViewCell:BaseTableViewOCCell
@end
...
-(void)loadUI{
    ...
    self.dataArray = [NSMutableArray arrayWithObjects:@"桌上美食",@"真心真艺",@"音响科技有限公司",@"智联招聘",@"前程无忧",@"百度百科",@"雅虎中国",@"360",@"布丁酒店",@"如家",@"莫泰168",@"宜家家居",@"微软中国",@"苹果公司",@"IBM",nil];
