...
class FirstViewController: XBaseViewController,UICollectionViewDataSource, UICollectionViewDelegate,UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        buildSettings()
        homecollectionView.register(CollectionViewCell1.self, forCellWithReuseIdentifier: CollectionViewCell1.getColloctionCellIdentifier())
        homecollectionView.register(CollectionViewCell2.self, forCellWithReuseIdentifier: CollectionViewCell2.getColloctionCellIdentifier())
    ...
    func collectionView(_ cv: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if exampleSwitch.isOn {
            let cell = cv.dequeueReusableCell(withReuseIdentifier: CollectionViewCell1.getColloctionCellIdentifier(), for: indexPath) as? CollectionViewCell1
            ...
            let cell = cv.dequeueReusableCell(withReuseIdentifier: CollectionViewCell2.getColloctionCellIdentifier(), for: indexPath) as? CollectionViewCell2
            cell?.title.text = dic["title"]
    ...
    func keyBoardWillShow(_ note: Notification?) {
        if let timeIntervar:TimeInterval = note?.userInfo![UIKeyboardAnimationDurationUserInfoKey] as? TimeInterval{
