...
class FreedomBaseLoginViewController: XBaseViewController,UITextFieldDelegate,RCIMConnectionStatusDelegate {
    ...
    lazy var phoneT : LoginTextField = {
        ...
        phone.attributedPlaceholder = NSAttributedString(string: "手机号", attributes: [NSAttributedStringKey.foregroundColor:UIColor.white,NSAttributedStringKey.font:Font(14)])
        return phone
    }()
    lazy var userNameT : LoginTextField = {
        ...
        userNT.attributedPlaceholder = NSAttributedString(string: "用户名", attributes: [NSAttributedStringKey.foregroundColor:UIColor.white,NSAttributedStringKey.font:Font(14)])
      return userNT
    }()
    lazy var passWordT : LoginTextField = {
        ...
        pass.attributedPlaceholder = NSAttributedString(string: "密码", attributes: [NSAttributedStringKey.foregroundColor:UIColor.white,NSAttributedStringKey.font:Font(14)])
        return pass
    }()
    ...
    lazy var messageCodeT : LoginTextField = {
        ...
        code.attributedPlaceholder = NSAttributedString(string: "验证码", attributes: [NSAttributedStringKey.foregroundColor:UIColor.white,NSAttributedStringKey.font:Font(14)])
        return code
    }()
    //FIXME:程序开始
