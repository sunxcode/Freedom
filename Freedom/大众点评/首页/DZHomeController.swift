...
class DZHomeViewCell1:BaseCollectionViewCell{
    func initUI() {
        ...
        addSubviews(view, view2, icon, view3, nil)
    }
...
class DZHomeViewCell2:BaseCollectionViewCell{
    ...
    func initUI() {
        ...
        addSubviews(icon, title, script, nil)
    }
...
class DZHomeViewCell4:BaseCollectionViewCell{
    ...
    func initUI() {
        ...
        addSubviews(icon, title, a, script, b, d, ling, nil)
    }
    func setCollectionDataWithDic(_ dict: [AnyHashable: Any]?) {
...
class DZHomeHeadView1: UICollectionReusableView {
    var DZtoutiaoV: BaseScrollOCView?
    ...
    func initUI() {
        DZtoutiaoV = BaseScrollOCView.sharedViewBanner(withFrame: CGRect(x: 20, y: 0, width: APPW - 40, height: 60), viewsNumber: 5, viewOfIndex: {(_ index: Int) -> UIView in
...
class DZHomeController: DianpingBaseViewController {
    ...
    func viewDidLoad() {
        ...
        itemScrollView = BaseScrollOCView.sharedScrollItem(withFrame: CGRect(x: 0, y: 60, width: APPW, height: 200), icons: icons, titles: titles, size: CGSize(width: APPW / 5.0, height: 70), hang: 2, round: true)
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            if indexPath.section == 0 {
                ...
                cell = collectionView.dequeueReusableCell(withReuseIdentifier: "DZHomeViewCell2", for: indexPath)
                cell?.collectionDataWithDic = nil
            } else if indexPath.section == 2 {
                cell = collectionView.dequeueReusableCell(withReuseIdentifier: "DZHomeViewCell3", for: indexPath)
                cell?.collectionDataWithDic = nil
            } else {
                cell = collectionView.dequeueReusableCell(withReuseIdentifier: "DZHomeViewCell4", for: indexPath)
                cell?.collectionDataWithDic = nil
            }
            if let aCell = cell {
                return aCell
