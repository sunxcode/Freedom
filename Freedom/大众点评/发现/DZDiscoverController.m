...
-(void)buildUI{
    ...
    contentScrollView = [BaseScrollOCView sharedContentTitleViewWithFrame:CGRectMake(0, 0, APPW, APPH-55) titles:titles controllers:controllers inViewController:self];
