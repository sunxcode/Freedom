...
- (void)setLeftBarButtonItem:(UIBarButtonItem *)item animated:(BOOL)animated{
    if (item == nil) {
        ...
        [self setLeftBarButtonItems:@[[UIBarButtonItem fixItemSpace:-5], item] animated:animated];
    }
}
- (void)setRightBarButtonItem:(UIBarButtonItem *)item animated:(BOOL)animated{
    if (item == nil) {
        ...
        [self setRightBarButtonItems:@[[UIBarButtonItem fixItemSpace:-5], item] animated:animated];
    }
}
