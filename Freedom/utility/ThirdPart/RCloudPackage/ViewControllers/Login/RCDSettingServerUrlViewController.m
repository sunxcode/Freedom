...
- (void)viewDidLoad {
    ...
    demoServerTextField.attributedPlaceholder = [[NSAttributedString alloc]initWithString:@"请输入demo服务器地址" attributes:@{NSForegroundColorAttributeName : color}];
    ...
    [demoServerTextField addTarget:self action:@selector(textFieldDidChange:) forControlEvents:UIControlEventEditingChanged];
...
//    userNameMsgLb.text = @"demo server";
    ...
    naviServerTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入导航服务器地址" attributes:@{NSForegroundColorAttributeName : color}];
    ...
    [naviServerTextField addTarget:self action:@selector(textFieldDidChange:) forControlEvents:UIControlEventEditingChanged];
    ...
    fileServerTextField.attributedPlaceholder = [[NSAttributedString alloc]initWithString:@"请输入文件服务器地址" attributes:@{NSForegroundColorAttributeName : color}];
...
//    pswMsgLb.text = @"6-16位字符区分大小写";
    ...
    appKeyTextField.attributedPlaceholder = [[NSAttributedString alloc]initWithString:@"请输入App Key" attributes:@{NSForegroundColorAttributeName : color}];
    appKeyTextField.translatesAutoresizingMaskIntoConstraints = NO;
    appKeyTextField.text = [RCDSettingUserDefaults getRCAppKey];
    [appKeyTextField addTarget:self action:@selector(textFieldDidChange:) forControlEvents:UIControlEventEditingChanged];
