...
- (void)viewWillAppear:(BOOL)animated {
  ...
  //自定义rightBarButtonItem
    UIBarButtonItem *rightBtn = [FreedomTools barButtonItemContainImage:[UIImage imageNamed:@"add"] imageViewFrame:CGRectMake(0, 0, 17, 17) buttonTitle:nil titleColor:nil titleFrame:CGRectZero buttonFrame:CGRectMake(0, 0, 17, 17) target:self action:@selector(showMenu:)];
