...
static WechatRootViewController *rootVC = nil;
@interface WechatRootViewController ()
...
@end
@implementation WechatRootViewController
+ (WechatRootViewController *) sharedRootViewController{
    static dispatch_once_t once;
    dispatch_once(&once, ^{
        rootVC = [[WechatRootViewController alloc] init];
    });
    return rootVC;
}
- (void)viewDidLoad {
