...
@end
@interface WechatMenuViewController ()
@end
@implementation WechatMenuViewController
- (void) loadView{
...
- (void) viewDidLoad{
    [super viewDidLoad];
    [self.tableView registerClass:[WechatMenuCell class] forCellReuseIdentifier:@"TLMenuCell"];
}
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    WechatMenuCell *cell = [tableView dequeueReusableCellWithIdentifier:@"TLMenuCell"];
