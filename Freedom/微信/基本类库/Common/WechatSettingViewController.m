...
@property (nonatomic, strong) TLSettingItem *item;
@end
@interface WechatSettingCell : UITableViewCell
@property (nonatomic, strong) TLSettingItem *item;
@end
...
@end
@interface WechatSettingCell ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UILabel *rightLabel;
@property (nonatomic, strong) UIImageView *rightImageView;
@end
@implementation WechatSettingCell
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        [self.contentView addSubview:self.titleLabel];
...
@end
@implementation WechatSettingViewController
- (void)loadView{
...
- (void)viewDidLoad{
    ...
    [self.tableView registerClass:[WechatSettingCell class] forCellReuseIdentifier:@"TLSettingCell"];
