...
@interface WechatQRCodeViewController ()
...
@end
@implementation WechatQRCodeViewController
...
- (void)setQrCode:(NSString *)qrCode{
    _qrCode = qrCode;
    [WechatQRCodeViewController createQRCodeImageForString:qrCode ans:^(UIImage *ansImage) {
