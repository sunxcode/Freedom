...
@interface WechatInfoCell ()
@property (nonatomic, strong) UILabel *subTitleLabel;
@end
@implementation WechatInfoCell
...
@end
@interface WechatInfoButtonCell ()
@property (nonatomic, strong) UIButton *button;
@end
@implementation WechatInfoButtonCell
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
...
@end
@implementation WechatInfoViewController
- (void) loadView{
...
- (void)viewDidLoad{
    ...
    [self.tableView registerClass:[WechatInfoCell class] forCellReuseIdentifier:@"TLInfoCell"];
    [self.tableView registerClass:[WechatInfoButtonCell class] forCellReuseIdentifier:@"TLInfoButtonCell"];
}
