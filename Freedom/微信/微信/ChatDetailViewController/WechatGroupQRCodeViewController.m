...
@interface WechatGroupQRCodeViewController () <TLActionSheetDelegate>
@property (nonatomic, strong) WechatQRCodeViewController *qrCodeVC;
@end
@implementation WechatGroupQRCodeViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)rightBarButtonDown:(UIBarButtonItem *)sender{
    WechatActionSheet *actionSheet = [[WechatActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"用邮件发送", @"保存图片", nil];
    [actionSheet show];
}
#pragma mark - Getter -
