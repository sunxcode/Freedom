...
@interface WechatFriendDetailAlbumCell : TLTableViewCell
...
@end
@interface WechatFriendDetailSettingViewController : WechatSettingViewController
...
- (void)viewDidLoad {
    ...
    self.data = [[WechatFriendHelper sharedFriendHelper] friendDetailSettingArrayByUserInfo:self.user];
}
@end
@implementation WechatFriendDetailViewController
- (void)viewDidLoad{
    [super viewDidLoad];
...
- (void)setUser:(TLUser *)user{
    _user = user;
    NSArray *array = [[WechatFriendHelper sharedFriendHelper] friendDetailArrayByUserInfo:self.user];
