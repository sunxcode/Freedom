...
/*通讯录 Cell*/
@interface WechatContactCell : TLTableViewCell
...
@end
@interface WechatContactsViewController () <UISearchBarDelegate>
@property (nonatomic, strong) WechatSearchController *searchController;
@end
@implementation WechatContactsViewController
- (void)viewDidLoad{
    [super viewDidLoad];
    ...
    [WechatFriendHelper tryToGetAllContactsSuccess:^(NSArray *data, NSArray *formatData, NSArray *headers) {
