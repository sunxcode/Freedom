...
@end
@interface WXScannerViewController () <AVCaptureMetadataOutputObjectsDelegate>
@property (nonatomic, strong) UILabel *introudctionLabel;
@property (nonatomic, strong) WXScannerView *scannerView;
@property (nonatomic, strong) WXScannerBackgroundView *scannerBGView;
@property (nonatomic, strong) AVCaptureSession *scannerSession;
@property (nonatomic, strong) AVCaptureVideoPreviewLayer *videoPreviewLayer;
@end
@implementation WXScannerViewController
...
- (WXScannerView *)scannerView{
    if (_scannerView == nil) {
        _scannerView = [[WXScannerView alloc] init];
    }
    return _scannerView;
}
- (WXScannerBackgroundView *)scannerBGView{
    if (_scannerBGView == nil) {
        _scannerBGView = [[WXScannerBackgroundView alloc] init];
    }
