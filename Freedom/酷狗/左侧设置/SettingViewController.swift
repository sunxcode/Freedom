...
class SettingViewController: KugouBaseViewController {
    ...
    func setupTableView() {
        self.tableView = UITableView(frame: CGRect(x: 0, y: (topView?.height())!, width: APPW, height: APPH - 210), style: .plain) as! BaseTableView as! BaseTableView
